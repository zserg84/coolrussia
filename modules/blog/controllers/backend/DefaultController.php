...
use modules\blog\models\backend\BlogSearch;
use modules\blog\models\backend\BlogsLangSearch;
use vova07\admin\components\Controller;
use modules\blog\models\backend\Blog;
...
//                    return $this->redirect(['update', 'id' => $model->id]);
    ...
    public function actionUpdate($id)
    {
        ...
        $blogsLangSearchModel = new BlogsLangSearch();
        $blogsLangDataProvider = $blogsLangSearchModel->search(Yii::$app->request->get());
        ...
        return $this->render('update', [
                'model' => $model,
                'statusArray' => $statusArray,
                'blogsLangDataProvider' => $blogsLangDataProvider,
                'blogsLangSearchModel' => $blogsLangSearchModel,
            ]);
    }
